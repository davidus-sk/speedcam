...
class DB {
	...
	public function createSchemas() {
		...
		$this->conn->exec('CREATE TABLE IF NOT EXISTS detections (time, month INTEGER, day INTEGER, hour INTEGER, year INTEGER, camera INTEGER, radar, speed, plate, image1, image2)');
	}//function
}//class
